  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
            <button
             data-id="<?php echo $exm['pat_id']?>"
             data-msg="<?php echo $exm['doc_message']?>"
              class="btn btn-success edit" data-toggle="modal" data-target="#exampleModal">
...
<script>
    $(".edit").on("click",function(){
        var id = $(this).data("id");
        var doc_message = $(this).data("msg");
        $("#pat_id").val(id);
        $("#doc_message").val(doc_message);
    })
</script>
</body>
</html>